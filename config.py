...
learn.add_argument("--max_epoch", type=int, default=30)
...
misc.add_argument("--log_step", type=int, default=50)
misc.add_argument("--save_epoch", type=int, default=5)
misc.add_argument("--max_save_num", type=int, default=8)
